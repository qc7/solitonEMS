# Generated by Django 2.2.1 on 2019-12-23 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hod', models.CharField(default='Pending', max_length=15)),
                ...
                ('hr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hr', to='employees.Employee')),
                ('leave_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leave.Leave_Types')),
                ('supervisor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Supervisor', to='employees.Employee')),
